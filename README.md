[![Build Status](https://travis-ci.org/buckie/kadena.svg?branch=develop)](https://travis-ci.org/buckie/kadena)
...
* `rlwrap`: used in `kadenaclient.sh` to make things more pleasant
